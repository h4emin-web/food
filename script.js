...
const partnerPosts = [
  {
    ...
    mode: "OEM",
    trade: "구매",
    title: "닭가슴살을 활용한 스프, 육포, 젤리 OEM 업체를 찾습니다.",
    company: "바른단백푸드",
    business: "브랜드",
    desc: "닭가슴살 원료를 활용한 상온·냉장 간편식 제품을 함께 개발하고 생산할 수 있는 OEM 협력사를 찾습니다. 초기 테스트 물량 이후 정기 발주까지 검토하고 있습니다.",
    author: "바른단백푸드",
    date: "방금 전",
    views: 46,
  },
  {
    ...
    mode: "ODM",
    trade: "판매",
    title: "건강즙 ODM 제조 협력 가능합니다.",
    company: "초록담제조",
    business: "제조",
    desc: "배즙, 양배추즙, 석류즙 등 액상 파우치 제품의 배합 개발부터 충진, 포장까지 대응 가능합니다. 소량 테스트와 본생산 모두 협의 가능합니다.",
    author: "초록담제조",
    date: "15분 전",
    views: 15,
  },
  {
    ...
    mode: "OEM",
    trade: "판매",
    title: "프로틴바·에너지바 소량 OEM 생산 가능합니다.",
    company: "뉴트리웍스",
    business: "제조",
    desc: "견과, 곡물, 단백질 원료 기반의 바 제품을 레시피 조정부터 성형, 개별 포장까지 지원합니다. 스타트업 테스트 물량과 시즌 기획 제품 생산이 가능합니다.",
    author: "뉴트리웍스",
    date: "1시간 전",
    views: 32,
  },
